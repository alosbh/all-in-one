...
"border-color: transparent;")
        ...
        self.btn_atender = QtWidgets.QPushButton(self.centralwidget)
        self.btn_atender.setGeometry(QtCore.QRect(20, 200, 151, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_atender.sizePolicy().hasHeightForWidth())
        self.btn_atender.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.btn_atender.setFont(font)
        self.btn_atender.setStyleSheet("background-color:rgb(180, 231, 180);")
        ...
        self.btn_concluir = QtWidgets.QPushButton(self.centralwidget)
        self.btn_concluir.setGeometry(QtCore.QRect(20, 200, 151, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_concluir.sizePolicy().hasHeightForWidth())
        self.btn_concluir.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.btn_concluir.setFont(font)
        self.btn_concluir.setStyleSheet("background-color:rgb(180, 231, 180);")
        self.btn_concluir.setObjectName("btn_concluir")
