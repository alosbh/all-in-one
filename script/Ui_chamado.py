...
"border-color: transparent;")
        ...
        self.lista_motivos.setGeometry(QtCore.QRect(180, 130, 161, 22))
        self.lista_motivos.setObjectName("lista_motivos")
        self.lbl_time = QtWidgets.QLabel(self.centralwidget)
        self.lbl_time.setGeometry(QtCore.QRect(60, 20, 101, 31))
        font = QtGui.QFont()
        ...
        self.btn_solicitar.setGeometry(QtCore.QRect(90, 180, 131, 41))
        ...
        self.rd_btn_engenharia.setGeometry(QtCore.QRect(180, 30, 82, 17))
        ...
        self.rd_btn_manufatura.setGeometry(QtCore.QRect(180, 50, 82, 17))
        ...
        self.rd_btn_ic.setGeometry(QtCore.QRect(180, 90, 82, 17))
        ...
        self.rd_btn_qualidade.setGeometry(QtCore.QRect(180, 70, 82, 17))
        self.rd_btn_qualidade.setObjectName("rd_btn_qualidade")
        self.lbl_motivos = QtWidgets.QLabel(self.centralwidget)
        self.lbl_motivos.setGeometry(QtCore.QRect(60, 130, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.lbl_tempo.setGeometry(QtCore.QRect(300, 70, 111, 51))
        font = QtGui.QFont()
        ...
        self.lbl_status.setGeometry(QtCore.QRect(310, 40, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.btn_cancelar.setGeometry(QtCore.QRect(250, 180, 131, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btn_finalizar.setGeometry(QtCore.QRect(90, 180, 131, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_time.setText(_translate("MainWindow", "Solicitar suporte:"))
