...
class Announcements_controller(Async_login_routine):
    def load_announcements_label(self):
        ...
        try:
            ...
            url3_pixmap = self.get_pixmap('http://brbelm0itqa01/AIOServiceSTG/Images5S/Toolbox.png')
        ...
        try:
            ...
            url4_pixmap = self.get_pixmap('http://brbelm0itqa01/AIOServiceSTG/Images5S/Environment.png')
