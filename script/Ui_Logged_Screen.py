...
"border-radius:10px")
        ...
        self.webfoto = QWebView(self.FotoWindow)
        self.webfoto.setGeometry(QtCore.QRect(0, 40, 683, 384))
...
"border:10px;")
        ...
        self.pagtotal = QtWidgets.QLabel(self.FotoWindow)
        ...
        self.barra = QtWidgets.QLabel(self.FotoWindow)
...
"Clique Aqui"))
        ...
        self.ReleaseNotes.setText(_translate("Logged", "<html><head/><body><p>v51:</p><p>• Nova função: Botão de 5S - Posto Modelo.</p><p>v47: </p><p>• Novo botão customizável no menu lateral.</p><p>• Atalho para tela inicial transferido para o logo da JABIL no canto superior esquerdo.</p><p>• Ficha de Instrução alterado para o novo sistema FI Creator.</p><p>v46:</p><p>• Novo botão Reset no canto superior direito da tela inicial, para reiniciar o dispositivo se necessário.</p><p><br/></p></body></html>"))
