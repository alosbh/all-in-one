...
class MFRC522:
  ...
  def __init__(self, dev='/dev/spidev0.0', spd=1000000):
    try:
      ...
      print("Leitor de crachá não identificado, verifique se o cabo verde está ligado corretamente no raspberry.")
  ...
  #Metodo que retorna a matrícula JABIL
  def JABIL_Matricula(self):
    #Variavel de retorno
    matricula = None
    errorsMat = 0
    while (matricula == None and errorsMat <= 3):
      ...
      if status == self.MI_OK:
        #Chave para autenticacao dos crachas Jabil
