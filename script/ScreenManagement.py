...
class Logged_Screen(QtWidgets.QMainWindow, Ui_Logged_Screen, functions_5s, buttons_controller, jit_support_controller, LPAactions_controller, Announcements_controller, Fpl_controller, theme_controller, Async_login_routine):
    ...
    def SetupUser(self, DL):
        ...
        self.lbl_value_yield.setText(str(self.get_yield()))
        self.lbl_value_productivity.setText(str(self.get_productivity()))
        self.lbl_value_product.setText(str(self.get_client_name()))
        self.lbl_value_client.setText(str(self.get_product_name()))
    ...
    def load_stopwatcher(self):
        self.hide5s()
        url = "http://brbelm0apps99/Stopwatch?workstationId="+ str(self.Station.Id) + "&userId=" + str(self.thread.DL.ID)
        print("############")
        print(url)
        print("############")
