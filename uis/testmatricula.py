...
"border-style: solid;")
        ...
        self.MainThread_IconGray.setGeometry(QtCore.QRect(20, 720, 32, 32))
...
"")
        ...
        self.mainthreadicon_on.setEnabled(False)
        self.mainthreadicon_on.setGeometry(QtCore.QRect(70, 720, 32, 32))
        self.mainthreadicon_on.setAutoFillBackground(False)
...
"")
        ...
        self.ReadIcon.setGeometry(QtCore.QRect(20, 680, 32, 31))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI Semibold")
...
"")
        ...
        self.LogIcon.setGeometry(QtCore.QRect(70, 680, 32, 31))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI Semibold")
        font.setPointSize(10)
        font.setBold(True)
...
"")
        ...
        self.ResetBtn.setGeometry(QtCore.QRect(1305, 10, 50, 50))
        self.ResetBtn.setStyleSheet("background-color:rgb(230, 230, 230);\n"
" border-radius: 25px;\n"
"\n"
"")
    ...
    def retranslateUi(self, Matricula):
        ...
        self.ResetBtn.setText(_translate("Matricula", "Reset"))
